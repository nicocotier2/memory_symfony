...
{
    #[Route('/game/start/{themeId}', name: 'start_game')]
public function startGame(int $themeId, CarteRepository $carteRepository, ThemeRepository $themeRepository): Response
{
